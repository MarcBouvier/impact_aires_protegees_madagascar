...
Les éléments ci-dessous constituent le support pour les sessions pratiques de cet atelier. Il sont réalisée selon une approche ouverte, repoductible fondée sur un document de type notebook [@bedecarrats_alternative_2017]. L'analyse est réalisée en R, qui est à la fois un logiciel et un langage open sources dédiés à l'analyse de données. Les traitements sont réalisés en Quarto. Le même code source peut générer un rendu en LaTeX/PDF, HTML ou Word.
